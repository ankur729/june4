...
module.exports.cook_profile_update = function (req, res, next) {
    ...
    db.cook_infos.find({
        ...
        if (cook_info.gender != req.body.gender) {
            updated_obj = {};

            updated_obj.field_name = 'Gender';
            updated_obj.field_attr = "gender";
            updated_obj.field_value = req.body.gender;
            updated_obj.old_val = data[0].gender;
            updated_data.push(updated_obj);
            console.log('COOK gender CHANGED');
        }
